...
<div class="tab_list m1" align="center">
    <ul class="tabs">
    <li class="tab1"><a href="jQueryMain.do"><span>전체게시판</span></a>
        <ul>
        <li class="more">› <a href="#">전체게시판 더보기</a></li>
        </ul>
    </li>
    <li class="tab2"><a href="jQueryMain.do?category=기초익히기"><span>기초익히기</span></a>
        <ul>
        <li class="more">› <a href="#">기초익히기 더보기</a></li>
        </ul>
    </li>

    <li class="tab3"><a href="jQueryMain.do?category=등급올리기"><span>등급올리기</span></a>
        <ul>
        <li class="more">› <a href="#">등급올리기 더보기</a></li>
        </ul>
    </li>

    <li class="tab4"><a href="jQueryMain.do?category=질문게시판"><span>질문게시판</span></a>
        <ul>       
        <li class="more">› <a href="#">질문게시판 더보기</a></li>
        </ul>
    </li>
    
    <li class="tab5"><a href="jQueryMain.do?category=응용게시판"><span>응용게시판</span></a>
        <ul>       
	...
	<table class="tbl" align="center">
		...
		<c:forEach items="${jQueryMain }" var="jQuery">
			<tr>
				...
				<td><a href="findMember.do?nickname=${jQuery.nickname}">${jQuery.nickname }</a></td>
